...
<footer class="footer">
  <div class="footer-left">
    <a href="./index.php"><h3>ChroniclesNow</h3></a>
    <p>
    Stay informed and engaged with our cutting-edge news web app.
    </p>
    <p>
    &copyChroniclesNow <?php echo date("Y")?>
    </p>
    <div class="socials">
  ...
  <ul class="footer-right">
    ...
    <li>
      ...
      <ul class="box">
        <li>
          Share the story in your own words with the world. To Inspire with your writing make ChroniclesNow your platform to
